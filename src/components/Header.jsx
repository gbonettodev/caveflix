  ...
  return (
    <header className="border-b border-white/10 bg-[#07090d]/90 backdrop-blur-xl">
      <div className="mx-auto flex min-h-[4.5rem] w-[min(1180px,calc(100%-2rem))] items-center justify-between gap-6">
        ...
        <nav
          className={'absolute inset-x-0 top-[4.5rem] z-20 border-b border-white/10 bg-[#0b0e13] px-4 py-5 md:static md:block md:border-0 md:bg-transparent md:p-0 ' + (menuOpen ? 'block' : 'hidden')}
